...
// (DO NOT EDIT: machine generated header) 'FMX.Graphics.pas' rev: 33.00 (Windows)
...
/*Helper*/typedef void *TGradientStyleHelper;

class DELPHICLASS TGradient;
class DELPHICLASS TBrushResource;
/*Helper*/typedef void *TWrapModeHelper;

class DELPHICLASS TBrushBitmap;
/*Helper*/typedef void *TBrushKindHelper;

class DELPHICLASS TBrush;
/*Helper*/typedef void *TStrokeCapHelper;

/*Helper*/typedef void *TStrokeJoinHelper;

/*Helper*/typedef void *TStrokeDashHelper;
...
/*Helper*/typedef void *TFontWeightHelper;

/*Helper*/typedef void *TFontSlantHelper;

/*Helper*/typedef void *TFontStretchHelper;
...
/*Helper*/typedef void *TFillTextFlagHelper;
...
/*Helper*/typedef void *TCanvasQualityHelper;
...
private:
	...
	static _di_IFMXSystemFontService FFontSvc;
...
public:
	...
	virtual bool __fastcall LoadFromFile(const System::UnicodeString AFileName, Fmx::Surfaces::TBitmapSurface* const Bitmap, const unsigned MaxSizeLimit = (unsigned)(0x0)) = 0 ;
	virtual bool __fastcall LoadThumbnailFromFile(const System::UnicodeString AFileName, const float AFitWidth, const float AFitHeight, const bool UseEmbedded, Fmx::Surfaces::TBitmapSurface* const Bitmap) = 0 ;
	virtual bool __fastcall LoadFromStream(System::Classes::TStream* const AStream, Fmx::Surfaces::TBitmapSurface* const Bitmap, const unsigned MaxSizeLimit = (unsigned)(0x0)) = 0 ;
	virtual bool __fastcall SaveToFile(const System::UnicodeString AFileName, Fmx::Surfaces::TBitmapSurface* const Bitmap, const PBitmapCodecSaveParams SaveParams = (PBitmapCodecSaveParams)(0x0)) = 0 ;
	virtual bool __fastcall SaveToStream(System::Classes::TStream* const AStream, Fmx::Surfaces::TBitmapSurface* const Bitmap, const System::UnicodeString Extension, const PBitmapCodecSaveParams SaveParams = (PBitmapCodecSaveParams)(0x0)) = 0 ;
public:
...
public:
	...
	#pragma pack(push,8)
#endif /* not _WIN64 */
	struct DECLSPEC_DRECORD TBitmapCodecClassDescriptor
	{
	public:
		System::UnicodeString Extension;
		System::UnicodeString Description;
		TCustomBitmapCodecClass BitmapCodecClass;
		bool CanSave;
	};
#ifndef _WIN64
	#pragma pack(pop)
...
private:
	enum class DECLSPEC_DENUM TBitmapCodecDescriptorField : unsigned int { Extension, Description };
	
	
private:
	static System::Generics::Collections::TList__1<TBitmapCodecClassDescriptor>* FBitmapCodecClassDescriptors;
	__classmethod TBitmapCodecClassDescriptor __fastcall FindBitmapCodecDescriptor(const System::UnicodeString Name, const TBitmapCodecDescriptorField Field);
	__classmethod TCustomBitmapCodecClass __fastcall GuessCodecClass(const System::UnicodeString Name, const TBitmapCodecDescriptorField Field);
	
public:
	__classmethod void __fastcall UnInitialize();
	__classmethod void __fastcall RegisterBitmapCodecClass(const System::UnicodeString Extension, const System::UnicodeString Description, const bool CanSave, const TCustomBitmapCodecClass BitmapCodecClass);
	__classmethod void __fastcall UnregisterBitmapCodecClass(const System::UnicodeString Extension);
	...
	__classmethod bool __fastcall LoadFromFile(const System::UnicodeString AFileName, Fmx::Surfaces::TBitmapSurface* const Bitmap, const unsigned MaxSizeLimit = (unsigned)(0x0));
	...
	__classmethod bool __fastcall LoadFromStream(System::Classes::TStream* const AStream, Fmx::Surfaces::TBitmapSurface* const Bitmap, const unsigned MaxSizeLimit = (unsigned)(0x0));
	__classmethod bool __fastcall SaveToStream(System::Classes::TStream* const AStream, Fmx::Surfaces::TBitmapSurface* const Bitmap, const System::UnicodeString Extension, PBitmapCodecSaveParams SaveParams = (PBitmapCodecSaveParams)(0x0))/* overload */;
...
public:
	__classmethod System::UnicodeString __fastcall GetType(System::UnicodeString AFileName)/* overload */;
	__classmethod System::UnicodeString __fastcall GetType(System::Classes::TStream* AData)/* overload */;
public:
...
protected:
	...
	/*Helper*/typedef void *TMatrixMeaningHelper;
