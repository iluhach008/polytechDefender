...
// (DO NOT EDIT: machine generated header) 'FMX.Ani.pas' rev: 33.00 (Windows)
...
private:
	...
	class PASCALIMPLEMENTATION TAnimationDestroyer : public System::TObject
	{
		typedef System::TObject inherited;
	...
	public:
		/* TObject.Create */ inline __fastcall TAnimationDestroyer() : System::TObject() { }
		/* TObject.Destroy */ inline __fastcall virtual ~TAnimationDestroyer() { }
...
private:
	static TAnimationDestroyer* FDestroyer;
