...
// (DO NOT EDIT: machine generated header) 'FMX.Types.pas' rev: 33.00 (Windows)
...
/*Helper*/typedef void *TCornerHelper;

/*Helper*/typedef void *TCornerTypeHelper;

/*Helper*/typedef void *TSideHelper;

/*Helper*/typedef void *TTextAlignHelper;

/*Helper*/typedef void *TVertRectAlignHelper;

/*Helper*/typedef void *THorzRectAlignHelper;

/*Helper*/typedef void *TTextTrimmingHelper;

/*Helper*/typedef void *TStyledSettingHelper;

/*Helper*/typedef void *TMenuItemChangeHelper;

/*Helper*/typedef void *TScreenOrientationHelper;

struct TGestureEventInfo;
struct TTouch;
/*Helper*/typedef void *TFormStyleHelper;

/*Helper*/typedef void *TAlignLayoutHelper;
...
/*Helper*/typedef void *TVirtualKeyboardTypeHelper;

/*Helper*/typedef void *TVirtualKeyboardStateHelper;

/*Helper*/typedef void *TReturnKeyTypeHelper;
...
/*Helper*/typedef void *TInteractiveGestureHelper;

/*Helper*/typedef void *TGestureTypeHelper;

/*Helper*/typedef void *TGestureOptionHelper;
...
struct TDisplay;
/*Helper*/typedef void *TKeyKindHelper;
...
enum class DECLSPEC_DENUM TOSPlatform : unsigned int { Windows, OSX, iOS, Android };
...
private:
	...
	System::Generics::Collections::TDictionary__2<System::UnicodeString,TFmxObject*>* FStyleObjectsDict;
...
protected:
	...
	void __fastcall DoInventory(System::Generics::Collections::TDictionary__2<System::UnicodeString,TFmxObject*>* Dict, const System::UnicodeString Prefix);
...
public:
	...
	virtual System::UnicodeString __fastcall ItemClass();
	...
	virtual TFmxObject* __fastcall FindStyleResource(const System::UnicodeString AStyleLookup, const bool Clone = false)/* overload */;
