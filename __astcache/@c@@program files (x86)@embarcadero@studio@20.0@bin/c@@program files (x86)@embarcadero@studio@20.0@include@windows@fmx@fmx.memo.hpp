...
// (DO NOT EDIT: machine generated header) 'FMX.Memo.pas' rev: 33.00 (Windows)
...
private:
	...
	Fmx::Memo::Types::TCaretPosition __cdecl GetCaretPosition();
	void __fastcall SetCaretPosition(const Fmx::Memo::Types::TCaretPosition &Value);
...
public:
	...
	void __fastcall DeleteFrom(const Fmx::Memo::Types::TCaretPosition &APosition, const int ALength, const Fmx::Memo::Types::TDeleteOptions Options);
	...
	__property Fmx::Memo::Types::TCaretPosition CaretPosition = {read=GetCaretPosition, write=SetCaretPosition};
...
static const System::Word MM_MEMO_USER = System::Word(0x172f);
...
static const System::Word PM_MEMO_GOTO_TEXT_BEGIN = System::Word(0x100d);
static const System::Word PM_MEMO_GOTO_TEXT_END = System::Word(0x100e);
