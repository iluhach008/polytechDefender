...
// (DO NOT EDIT: machine generated header) 'System.Math.Vectors.pas' rev: 33.00 (Windows)
...
struct tagVECTOR3D;
struct TMatrix;
/*Helper*/typedef void *TMatrixConstants;
...
public:
	...
	bool __fastcall operator==(const TMatrix& __rhs) { return TMatrix::_op_Equality(*this, __rhs); };
...
public:
	...
	TVector3D __fastcall operator+(const TVector3D& __rhs) { return TVector3D::_op_Addition(*this, __rhs); };
	...
	bool __fastcall operator==(const TVector3D& __rhs) { return TVector3D::_op_Equality(*this, __rhs); };
	static bool __fastcall _op_Inequality(const TVector3D &AVector1, const TVector3D &AVector2);
	bool __fastcall operator!=(const TVector3D& __rhs) { return TVector3D::_op_Inequality(*this, __rhs); };
	...
	TVector3D __fastcall operator*(const TVector3D& __rhs) { return TVector3D::_op_Multiply(*this, __rhs); };
	static TVector3D __fastcall _op_Multiply(const TVector3D &AVector, const float AFactor);
	TVector3D __fastcall operator*(const float& __rhs) { return TVector3D::_op_Multiply(*this, __rhs); };
	...
	TVector3D __fastcall operator/(const float& __rhs) { return TVector3D::_op_Division(*this, __rhs); };
