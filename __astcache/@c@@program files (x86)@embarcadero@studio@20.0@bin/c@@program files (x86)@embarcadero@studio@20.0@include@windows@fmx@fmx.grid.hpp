...
// (DO NOT EDIT: machine generated header) 'FMX.Grid.pas' rev: 33.00 (Windows)
...
public:
	virtual System::UnicodeString __fastcall ValueToString(const System::Rtti::TValue &Value);
public:
	/* TDateColumn.Create */ inline __fastcall virtual TTimeColumn(System::Classes::TComponent* AOwner) : TDateColumn(AOwner) { }
...
public:
	...
	__property bool ShowThousandSeparator = {read=FShowThousandSeparator, write=SetShowThousandSeparator, nodefault};
public:
...
__published:
	__property DecimalDigits = {default=2};
	__property ShowThousandSeparator;
public:
