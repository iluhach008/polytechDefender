...
// (DO NOT EDIT: machine generated header) 'FMX.TextLayout.pas' rev: 33.00 (Windows)
...
public:
	...
	__property System::Uitypes::TAlphaColor Color = {read=FColor, write=FColor, default=-16777216};
