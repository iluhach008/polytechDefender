...
// (DO NOT EDIT: machine generated header) 'FMX.Styles.pas' rev: 33.00 (Windows)
...
private:
	...
	typedef System::StaticArray<System::UnicodeString, 4> _TStyleDescription__2;
	
	typedef System::StaticArray<System::UnicodeString, 4> _TStyleDescription__3;
