...
// (DO NOT EDIT: machine generated header) 'FMX.Platform.pas' rev: 33.00 (Windows)
...
/*Helper*/typedef void *TScrollingBehaviourHelper;
...
/*Helper*/typedef void *TCaretBehaviorHelper;
