...
// (DO NOT EDIT: machine generated header) 'FMX.Pickers.pas' rev: 33.00 (Windows)
...
/*Helper*/typedef void *TDropDownKindHelper;

class DELPHICLASS TCustomPicker;
/*Helper*/typedef void *TDatePickerShowModeHelper;
