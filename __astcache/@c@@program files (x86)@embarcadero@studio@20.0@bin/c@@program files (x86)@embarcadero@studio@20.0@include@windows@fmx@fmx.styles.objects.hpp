...
// (DO NOT EDIT: machine generated header) 'FMX.Styles.Objects.pas' rev: 33.00 (Windows)
...
/*Helper*/typedef void *TStyleTriggerHelper;

class DELPHICLASS TBitmapLink;
/*Helper*/typedef void *TCapWrapModeHelper;
